...
//Moves forward towards lefright neutral goal
...
//Moves forward to prepare for turn
leftBackWheel.startRotateFor(vex::directionType::fwd, 200, vex::rotationUnits::deg);
rightBackWheel.rotateFor(vex::directionType::rev, 200, vex::rotationUnits::deg);
//Turns left 90 Degrees
leftBackWheel.startRotateFor(vex::directionType::rev, 750, vex::rotationUnits::deg);
rightBackWheel.rotateFor(vex::directionType::rev, 750, vex::rotationUnits::deg);
...
rightBackWheel.rotateFor(vex::directionType::rev, 1500, vex::rotationUnits::deg);
//Moves backwards towards left neutral goal
leftBackWheel.startRotateFor(vex::directionType::rev, 500, vex::rotationUnits::deg);
rightBackWheel.rotateFor(vex::directionType::fwd, 500, vex::rotationUnits::deg);
//Clamps Back Side
...
rightBackWheel.rotateFor(vex::directionType::rev, 1000, vex::rotationUnits::deg);
//Stops Clamp Movement
leftBackClamp.stop();
rightBackClamp.stop();
}
