...
//Lowers front arm
leftFrontArm.startRotateFor(vex::directionType::fwd, 750, vex::rotationUnits::deg);
rightFrontArm.rotateFor(vex::directionType::rev, 750, vex::rotationUnits::deg);
//Moves forwards towards left neutral goal
leftBackWheel.startRotateFor(vex::directionType::fwd, 1800, vex::rotationUnits::deg);
rightBackWheel.rotateFor(vex::directionType::rev, 1800, vex::rotationUnits::deg);
//Lifts front arm
leftFrontArm.startRotateFor(vex::directionType::rev, 750, vex::rotationUnits::deg);
rightFrontArm.rotateFor(vex::directionType::fwd, 750, vex::rotationUnits::deg);

//Turns right slightly
leftBackWheel.startRotateFor(vex::directionType::fwd, 450, vex::rotationUnits::deg);
rightBackWheel.rotateFor(vex::directionType::fwd, 450, vex::rotationUnits::deg);

//Lowers front arm
leftFrontArm.startRotateFor(vex::directionType::fwd, 500, vex::rotationUnits::deg);
rightFrontArm.rotateFor(vex::directionType::rev, 500, vex::rotationUnits::deg);
//Moves forward towards middle neutral goal
...
/*
//Lifts front arm
leftFrontArm.startRotateFor(vex::directionType::rev, 500, vex::rotationUnits::deg);
rightFrontArm.rotateFor(vex::directionType::fwd, 500, vex::rotationUnits::deg);
//Lowers front arm
leftFrontArm.startRotateFor(vex::directionType::fwd, 500, vex::rotationUnits::deg);
rightFrontArm.rotateFor(vex::directionType::rev, 500, vex::rotationUnits::deg);
//Moves forward towards right neutral goal
leftBackWheel.startRotateFor(vex::directionType::fwd, 500, vex::rotationUnits::deg);
rightBackWheel.rotateFor(vex::directionType::rev, 500, vex::rotationUnits::deg);
*/
}
