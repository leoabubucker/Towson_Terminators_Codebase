...
{ 
  puncher.spinFor(20000, vex::rotationUnits::deg, 75, vex::velocityUnits::pct, true);  
  turn(180, "left", 50);
  drive(60, "fwd", 100);
  turn(45, "right", 50);
  leftWing.spinFor(100, vex::rotationUnits::deg, 75, vex::velocityUnits::pct, true);
  rightWing.spinFor(100, vex::rotationUnits::deg, 75, vex::velocityUnits::pct, true);
  drive(52, "fwd", 100);
  drive(12, "rev", 100);
}
